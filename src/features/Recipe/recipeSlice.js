...
export const fetchRecipes = createAsyncThunk("/recipes/fetchRecipes", async () => {
    const response = await axios.get("https://recipe-organiser-server.vercel.app/recipes")
...
export const addRecipeAsync = (newRecipe) => async (dispatch) => {
    try {
        const response = await fetch("https://recipe-organiser-server.vercel.app/recipes", {
            method: "POST",
            headers: {
...
export const deleteRecipeAsync = (recipeId) => async (dispatch) => {
    try {
        const response = await fetch(`https://recipe-organiser-server.vercel.app/recipes/deleteRecipe/${recipeId}`, {
            method: "DELETE"
        })
